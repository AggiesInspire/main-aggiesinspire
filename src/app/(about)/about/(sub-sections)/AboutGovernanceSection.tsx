...
const AboutGovernanceSection = ({ setSelectedPage }: Props) => {
    ...
    <section id="governance" className="mx-auto bg-gray-50 pt-20 pb-40">
      <div className="md:px-10 w-11/12 pb-14">
        <LargeHeading size={"lg"}>
          <InViewEffect>
            <TypeWriter text={"Governance"} interval={50} Markup="span" />
          </InViewEffect>
        </LargeHeading>
      </div>
      <motion.div
        onViewportEnter={() => setSelectedPage(AboutSelectedPage.Governance)}
